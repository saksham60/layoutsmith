# Creating a local-use Python script to scan the repo for the three query groups.
# It prints grep-like results to stdout and also writes a report file.
# The user can download it and run locally.
...
SCRIPT_PATH = "/mnt/data/scan_layoutsmith.py"
